---
title: 🔑 Permissions & Commands Quick Reference
---
...
| `/item_name <player> [name] [options]` | Read or edit the main-hand item_name component. | `sparrow.command.item-name` |
| `/custom_name <player> [name] [options]` | Read or edit the main-hand custom_name component. | `sparrow.command.custom-name` |
...
See [Patrol](./features/patrol.mdx), [Highlight](./features/highlight.mdx), and [Heads](./features/head.mdx) for their complete usage.
