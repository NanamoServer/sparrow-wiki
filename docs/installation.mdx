...
<Admonition type="warning" title="Storage service versions">
...
<PluginFileTree
  title="Sparrow"
  initialTreeData={[
    { id: "libs", name: "libs", hoverText: "Automatically managed runtime dependencies", children: [] },
    { id: "translations", name: "translations", hoverText: "Localized messages and interface text", children: [] },
    { id: "config.yml", name: "config.yml", isLeaf: true, hoverText: "Redis, database, language, and text parsing" },
    { id: "server.yml", name: "server.yml", isLeaf: true, hoverText: "Unique server ID" },
    { id: "commands.yml", name: "commands.yml", isLeaf: true, hoverText: "Command switches, entry points, and permissions; restart required" },
    { id: "features.yml", name: "features.yml", isLeaf: true, hoverText: "Feature switches and settings" },
  ]}
/>

<div style={{ marginBottom: "32px" }} />

<Admonition type="info" title="The first startup shuts down the server">
...
Set `forced-locale: en_US` in `config.yml` to select the console language. See [Permissions & Commands](./commands.mdx) and the individual feature pages for details.
